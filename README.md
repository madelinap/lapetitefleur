...
The virtual assistant modeule is a [RAG](https://www.pinecone.io/learn/retrieval-augmented-generation/) application using a Pinecone index previously created to serve the OpenAI API with content about each place. These modules are used on [www.nature-quebec.com](https://www.nature-quebec.com) website, property of lapetitefleur company.
